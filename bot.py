...
#     keyboard = [
#         [KeyboardButton("🏥 Дорихона")],
#         [KeyboardButton("📋 Буюртма олиш")],
#         [KeyboardButton("💰 Нархлар рўйхати")],
#         [KeyboardButton("🔚 Иш кунининг охири", request_location=True)]
#     ]
#     return ReplyKeyboardMarkup(keyboard, resize_keyboard=True)
...
#         # Admin panelidagi inline tugmalar uchun callback handler
#     app.add_handler(CallbackQueryHandler(admin_callback_handler, pattern="^admin_"))
#         # Admin holatida matnli xabarlarni qayta ishlash
#         # Bu handler boshqa matnli xabar handlerlaridan oldin bo'lishi kerak
#         # va faqat admin holatida ishga tushishi kerak.
#     app.add_handler(MessageHandler(
#             filters.TEXT & ~filters.COMMAND & filters.User(ADMIN_IDS),
#             lambda update, context: admin_handle_text_message(update, context) if context.user_data.get('admin_state') else None
#         ))
#     # Handlerlarni qo'shish


#     app.add_handler(CommandHandler("start", start))
#     app.add_handler(CommandHandler("reset_auth", reset_auth))  # YANGI
